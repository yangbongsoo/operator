...
// GetLatencyStats returns download latency statistics in the desired JSON format
		...
		return map[string]any{
			"downloadLatency": map[string]any{
				...
				"dataTransfer": map[string]any{
					"getObjectWithFileInfo": map[string]any{"latency": "0ms"},
					"erasureDecode": map[string]any{
						"totalParts":        0,
						"averageLatency":    "0ms",
						"minLatency":        "0ms",
						"maxLatency":        "0ms",
